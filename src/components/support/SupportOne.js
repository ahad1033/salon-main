...
const SupportOne = ({ className }) => {
  ...
  return (
    <section
      className={`${
        className
          ? "cta-subscribe bg-dark ptb-120 position-relative overflow-hidden important-bg"
    ...
    >
      ...
      <div className="container">
        ...
        >
          ...
          <div className="bg-circle rounded-circle circle-shape-3 position-absolute bg-dark-light left-5 important-bg-pink"></div>
          <div className="bg-circle rounded-circle circle-shape-1 position-absolute bg-warning right-5 important-bg-pink"></div>
        </div>
      </div>
    </section>
  );
